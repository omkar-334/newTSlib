...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.csdi_model = CSDI_base(self.target_dim, self.config_dict, self.device)
    ...
    def forward(self, x, mask=None, is_train=1):
        """
        Training/validation forward pass. Returns loss.
        x: (B, T, N)
        mask: (B, T, N) or None
